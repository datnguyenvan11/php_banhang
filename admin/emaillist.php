    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            ...
            <?php
                ...
                {
                    $email = $_POST['email'];
                    $query="Select * From emaildangky Where email like '%$email%'";
            ...
            ?>
                        <tbody>
                            ...
                            <form action="" method="post" role="form" name="formcheck">
                                <td><?php echo $row['stt']; ?></td>
                                <td><?php echo $row['email']; ?></td>
                                <td><input <?php if($row['active']==1) echo "checked" ?> type="checkbox" name="active" value="1" ></td>
                                <td><input type="submit" value="Đồng Ý" class="btn btn-success" name="btnSubmit"></td>
                                <td><input type="hidden" name="id" value="<?php echo $row['stt'] ?>"></td>
                            </form>
                            </tr>
            <?php
                        }
...
?>
        ...
        <?php
            if(isset($_POST['btnSubmit']))
            {
                ...
                echo $active."</br>";
                echo $stt;
                $query = "Update emaildangky set active='$active' where stt='$stt'";
                $con->query($query);
                echo '
                    <script type="text/javascript">
                        setTimeout('.'ReloadTrang("emaillist.php")'.', 0);
                    </script>  ';
            }
        ?>           
