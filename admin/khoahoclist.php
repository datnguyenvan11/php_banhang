            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="./"><p
                                style="font-size: 20px;color: white;font-family: 'Roboto Condensed', sans-serif;">
                            Admin</p></a>
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <a style="font-family: 'Roboto Condensed', sans-serif;" href="khoahoclist.php"
                               aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>Thống
                                Kê Khoá Học</a>
                        ...
                        <li class="menu-item-has-children dropdown">
                            <a style="font-family: 'Roboto Condensed', sans-serif;" href="userlist.php"
                               aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-tasks"></i>Tài
                                Khoản</a>
                            <ul class="sub-menu children ">
        ...
        <div id="right-panel" class="right-panel">
            ...
            <header id="header" class="header">
                <div class="header-menu">
                    <div class="col-sm-7">
                        <a id="menuToggle" class="menutoggle pull-left"><i class="fa fa fa-tasks"
                    ...
                    <div class="col-sm-5">
                        <div class="user-area dropdown float-right">
                            <a href="#" aria-haspopup="true" aria-expanded="false">
                                <img class="user-avatar rounded-circle" src="../upload/<?php echo $avatar ?>"
                                     alt="User Avatar">
                            </a>
                            <br>
                    ...
                    <div class="timkiem">
                        <form action="" method="POST" class="form-inline text-center" role="form">
                            <div class="form-group row">
                                <input type="text" class="form-control col-xs-10 col-sm-10 col-md-10 col-lg-10 " id=""
                                       placeholder="Nhập username cần tìm" size="140" name="searchKey">
                                <button type="submit"
                                        class="btn btn-danger hvr-underline-reveal col-xs-2 col-sm-2 col-md-2 col-lg-2"
                                        name="btnSearch">Tìm Kiếm
                                </button>
                            </div>
                        </form>
                        <!-- TIM KIEM -->
                        ...
                        if (isset($_POST['btnSearch'])) {
                            $key = "%{$_POST['searchKey']}%";
                            $query = ($key == "") ? "Select * From khoahoc where hide=1" : "Select * From khoahoc Where tenKhoa Like ?";
                            $stmt = $con->prepare($query);
                            if ($key != "") {
                                ...
                                <table class="table table-hover">
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['maKHoc'] ?></td>
                                            <td><span class="<?php echo $row['imgKHoc'] ?>"></span></td>
                                            <td>
                                                <a href="baihoc.php?maKHoc=<?php echo $row['maKHoc'] ?>"><?php echo $row['tenKhoa'] ?></a>
                                            </td>
                                            <td><?php echo $row['motaKHoc'] ?></td>
                                            <td><?php echo $row['hide'] ?></td>
                                            <td><a href="editKhoaHoc.php?id=<?php echo $row['id'] ?>"
        ...
        <script>
            jQuery('.delete-khoahoc').click(function () {
                if (confirm('Bạn có chắc muốn xóa không?')) {
                    ...
                    jQuery.ajax({
                        url: '/bankhoahoc/admin/deleteKhoaHoc.php?id=' + deleteId,
                        method: 'GET',
                        success: function () {
