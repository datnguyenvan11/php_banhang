        ...
        <div class="content mt-3">
            <div class="container">
                ...
                <?php
                    ...
                    {
                        $key = "%{$_POST['searchKey']}%";
                        $query = ($key=="")?"Select * From khoahoc":"Select * From khoahoc Where tenKhoa Like ?";
                        $stmt=$con->prepare($query);
                        if($key!="")
                        {
                ...
                ?>
                                ...
                                <tr>
                                    ...
                                    <td><a href="baihoc.php?maKHoc=<?php echo $row['maKHoc']?>"><?php echo $row['tenKhoa'] ?></a></td>
                                    <td><?php echo $row['motaKHoc'] ?></td>
                                    <td><?php echo $row['hide'] ?></td>
                                                                        <td><a href="editKhoaHoc.php?id=<?php echo $row['id'] ?>" class="btn btn-success">Sửa</a></td>
                                    <td><a href="deleteKhoaHoc.php?id=<?php echo $row['id'] ?>" class="btn btn-warning">Xoá</a></td>
                                </tr>
                <?php
                    }
                ?>
