                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        <div class="thumbnail khoahoc hvr-float" style="width: 350px;height: 450px;">
                            <img src="../img/khoahoc/<?php echo $row['imgBai'] ?>" style="border-radius: 10px;border: 1px solid #ddd; width: 100%;">
                            <div class="caption">
                                <h3><a style="text-decoration: none;color: black" href="chitiet.php?id=<?php echo $row['id'] ?>"><?php echo $row['tenBai'] ?></a></h3>
                                 <p><span style="font-weight: bold;font-size: 18px; color: red;"><?php echo $row['giatien'] ?> VNĐ</span>
                                </p>
                                ...
                                <p>
                                    <a href="#" class="btn btn-mua hvr-float-shadow"><span class="fa fa-credit-card"></span> Mua</a>
                                    <a href="javascript:addCart(<?php echo $row['id'] ?>)" class="btn btn-them hvr-float-shadow"><span class="fa fa-plus"></span> Thêm</a>
                                </p>
                            </div>
                        </div>
                    </div> <!-- endthum -->
                 ...
                 <ul class="pagination" style="font-size: 30px;">
                    <?php 
                        ...
                        {
                    ?>
                         <li class="<?php if($i==$page) echo "active" ?>"><a href="?maKHoc=<?php echo $maKHoc?>&page=<?php echo $i ?>"><?php echo $i; ?></a></li>
                    <?php  
                        }                      
                     ?>                    
                </ul>
