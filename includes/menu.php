        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        ?>
                        <li><a href="cart.php"><span class="glyphicon glyphicon-shopping-cart"></span> Giỏ Hàng <span
                ...
                <ul class="nav navbar-nav navbar-left ">
                    <ul class="nav navbar-nav navbar-left">
                        <li class="dropdown">
                            <a href="khoahoc/baihoc.php?maKHoc=All&page=1"
                               class="dropdown-toggle hvr-underline-from-center"><span
                                        class="fa fa-graduation-cap"></span>Khoá Học<span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ?>
                                    <li><a href="khoahoc/baihoc.php?maKHoc=<?php echo $row['maKHoc'] ?>&page=1"><span
                                                    class="<?php echo $row['imgKHoc'] ?>"></span>
                                            &nbsp; <?php echo $row['tenKhoa'] ?></a></li>
                                    <?php
                                }
                                ?>
                            </ul>
                        </li>
                        <li><a href="gioithieu.php" class="hvr-underline-from-center"><span
                                        class="fa fa-angellist"></span> Giới Thiệu</a></li>
                    </ul>
                </ul>
            </div><!-- /.navbar-collapse -->
        </div>
