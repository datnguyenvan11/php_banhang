			...
			<div class="container">
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					...
					<ul class="nav navbar-nav navbar-left ">
						    <ul class="nav navbar-nav navbar-left">
						      <li class="dropdown">
						      		<a href="khoahoc/baihoc.php?maKHoc=All&page=1" class="dropdown-toggle hvr-underline-from-center"   ><span class="fa fa-graduation-cap"></span>Khoá Học<span class="caret"></span></a>
								<ul class="dropdown-menu">
                                     <?php
                                        ...
                                        {
                                      ?>
                                  <li><a href="khoahoc/baihoc.php?maKHoc=<?php echo $row['maKHoc'] ?>&page=1"><span class="<?php echo $row['imgKHoc'] ?>"></span> &nbsp; <?php echo $row['tenKhoa'] ?></a></li>
                                       <?php
                                          }
                                         ?>
							    </ul>
